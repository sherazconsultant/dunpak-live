    ...
    <>
      ...
      <div className='pt-24'>
        <div className='container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center'>
          ...
          <div className='flex w-full md:w-3/5 py-6 mt-[-30px] text-center justify-center align-middle items-center'>
            <Image alt='hero image' src='/hero.png' width={500} height={500} />
